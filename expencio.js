                        ...
                        <div class="expense-item">
                            ...
                            <div style="display: flex; align-items: center; gap: 15px;">
                                ...
                                <div class="expense-actions">
                                    <button class="btn btn-small btn-secondary" onclick="editExpense(${actualIndex})">✏</button>
                                    <button class="btn btn-small btn-danger" onclick="deleteExpense(${actualIndex})">🗑</button>
                                </div>
                            </div>
                        </div>
                    `;
